...
export const AwardBadge = ({ type, place, link, customTopText, customBottomText }: AwardBadgeProps) => {
  ...
  return (
    <a
      ...
      href={link}
      target="_blank"
      className="block w-full max-w-[400px] h-auto cursor-pointer"
