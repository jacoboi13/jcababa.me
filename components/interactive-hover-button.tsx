...
const InteractiveHoverButton = React.forwardRef<HTMLAnchorElement, InteractiveHoverButtonProps>(
  ({ text = "Button", icon = "arrow", variant = "primary", className, asButton = false, ...props }, ref) => {
    ...
    const classes = cn(
      "group relative cursor-pointer overflow-hidden rounded-lg px-4 py-2 sm:px-6 sm:py-2.5 md:px-8 md:py-3 text-center font-semibold transition-all duration-300 min-w-[140px] sm:min-w-[180px] md:min-w-[200px] text-sm sm:text-base inline-block",
